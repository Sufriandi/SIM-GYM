    ...
    <div class="container mx-auto px-6 md:px-12">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ url('/') }}" class="flex items-center gap-3 group relative z-50">
                <div class="relative w-9 h-9 flex items-center justify-center transition-transform duration-300 group-hover:scale-105">
                    <img src="{{ asset('images/Logo.png') }}" alt="BETA GYM" class="w-full h-full object-contain relative z-10">
                    {{-- Glow tipis di belakang logo --}}
                    <div class="absolute inset-0 bg-gold-500/20 blur-lg rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                </div>
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <span class="text-[10px] font-bold text-gold-500 uppercase tracking-[0.25em] leading-tight group-hover:text-white transition-colors duration-300">
                        Premium
                    </span>
                </div>
            </a>
            ...
            <nav class="hidden lg:flex items-center gap-10">
                @foreach($links as $lnk)
                    <a href="{{ $lnk['href'] }}"
                       class="relative group py-2 block">
                        
                        {{-- Label Menu --}}
                        <span class="text-sm font-heading font-bold tracking-wider uppercase transition-colors duration-300
                                     {{ $lnk['active'] 
                                        ? 'text-gold-500' 
                                        : 'text-brand-textSoft group-hover:text-white' }}">
                            {{ $lnk['label'] }}
                        </span>

                        {{-- GARIS EMAS (ANIMATED UNDERLINE) --}}
                        <span class="absolute bottom-0 left-0 h-[2px] bg-gold-500 rounded-full transition-all duration-300 ease-out shadow-[0_0_8px_rgba(212,167,87,0.6)]
            ...
            <div class="hidden lg:flex items-center gap-6">
                ...
                <a href="{{ $registerUrl }}"
                   class="group relative px-6 py-2.5 bg-gold-500 text-brand-nav font-black text-sm uppercase tracking-widest rounded-full overflow-hidden transition-transform duration-300 hover:scale-105 shadow-[0_0_15px_-5px_rgba(212,167,87,0.5)]">
                    ...
                    {{-- Efek Kilau Lewat --}}
                    <div class="absolute top-0 -left-[100%] w-full h-full bg-gradient-to-r from-transparent via-white/30 to-transparent transform -skew-x-12 transition-all duration-700 group-hover:left-[100%]"></div>
                </a>
            </div>
            ...
            {{-- 4. MOBILE HAMBURGER --}}
            {{-- ========================================================= --}}
            <button class="lg:hidden relative z-50 text-white hover:text-gold-500 transition-colors focus:outline-none p-1"
                ...
                <div class="relative w-6 h-6 flex items-center justify-center">
                    ...
                    <svg x-show="mobileOpen" x-cloak xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
                </div>
            </button>
