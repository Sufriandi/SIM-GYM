...
<head>
    ...
    <meta name="description"
        content="BETA GYM Bengkalis - Pusat kebugaran premium dengan fasilitas lengkap, personal trainer bersertifikat, dan komunitas suportif. Mulai transformasi latihanmu hari ini!">
    <title>{{ $title }}</title>
    ...
    <style>
        ...
        .animate-slide-up {
            animation: slideUpFade .85s ease-out both;
        }
    </style>
...
<body
    ...
    <div class="fixed bottom-6 right-6 z-[100] animate-slide-up" style="animation-delay: 1s">
        ...
        <div class="relative group">
            ...
            {{-- 1. Custom Tooltip --}}
            <div
                class="absolute bottom-full right-0 mb-3 w-max opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 pointer-events-none">
                <div
                    class="bg-white text-gray-800 px-4 py-2 rounded-xl shadow-xl border border-gray-100 text-xs font-bold whitespace-nowrap">
                    Chat Admin WhatsApp
                    <div
                        class="absolute bottom-[-6px] right-6 w-3 h-3 bg-white transform rotate-45 border-r border-b border-gray-100">
                    </div>
                </div>
            </div>
            ...
            <button
                onclick="window.open('https://wa.me/{{ env('WA_ADMIN_NUMBER') }}?text=Halo%20Admin%20BETA%20GYM,%20saya%20butuh%20bantuan.', '_blank')"
                aria-label="Hubungi Admin BETA GYM melalui WhatsApp"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                    fill="currentColor" class="transform group-hover:rotate-12 transition-transform duration-300">
                    <path
                ...
                <span class="absolute top-0 right-0 flex h-3.5 w-3.5">
                    ...
                    <span
                        class="relative inline-flex rounded-full h-3.5 w-3.5 bg-red-500 border-2 border-[#25D366]"></span>
                </span>
            </button>
        </div>
    </div>
