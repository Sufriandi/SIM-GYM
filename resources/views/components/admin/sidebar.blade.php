        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-8 custom-scrollbar">
            ...
            <div class="space-y-2">
                ...
                <div x-show="openProduk" x-cloak x-collapse id="produk-submenu" class="space-y-1 mt-1 pl-4"
                    ...
                    <a href="{{ route('admin.produk.index') }}"
                        class="group flex items-center gap-3 pl-8 pr-4 py-2.5 text-sm transition-all duration-200 rounded-lg
                            {{ $produkMasterActive ? 'text-gold-300 font-medium bg-gradient-to-r from-gold-500/10 to-transparent' : 'text-brand-silver hover:text-white hover:bg-brand-gunmetal/30' }}"
                    ...
                    <a href="{{ route('admin.stok_produk.index') }}"
                        class="group flex items-center gap-3 pl-8 pr-4 py-2.5 text-sm transition-all duration-200 rounded-lg
                            {{ $stokActive ? 'text-gold-300 font-medium bg-gradient-to-r from-gold-500/10 to-transparent' : 'text-brand-silver hover:text-white hover:bg-brand-gunmetal/30' }}"
                ...
                <a href="{{ route('admin.latihan_harian.index') }}"
                    class="group flex items-center gap-4 px-4 py-3 rounded-2xl text-sm font-medium transition-all duration-300
                        {{ $latihanHarianActive ? 'bg-gradient-to-r from-gold-500/20 to-transparent text-gold-300 shadow-lg shadow-gold-500/20' : 'text-brand-silver hover:bg-brand-gunmetal/40 hover:text-white hover:translate-x-1' }}"
                ...
                <div x-show="openKehadiran" x-cloak x-collapse id="kehadiran-submenu" class="space-y-1 mt-1"
                    ...
                    <a href="{{ route('admin.izin_latihan.index') }}"
                        class="group flex items-center gap-3 pl-12 pr-4 py-2.5 text-sm transition-all duration-200
                            {{ $izinActive ? 'text-gold-300 font-medium bg-gradient-to-r from-gold-500/10 to-transparent' : 'text-brand-silver hover:text-white hover:bg-brand-gunmetal/30' }}">
                    ...
                    <a href="{{ route('admin.absensi.index') }}"
                        class="group flex items-center gap-3 pl-12 pr-4 py-2.5 text-sm transition-all duration-200
                            {{ $absensiActive ? 'text-gold-300 font-medium bg-gradient-to-r from-gold-500/10 to-transparent' : 'text-brand-silver hover:text-white hover:bg-brand-gunmetal/30' }}">
            ...
            <div class="space-y-2 mt-4">
                ...
                <a href="{{ route('admin.profil_gym.index') }}"
                    class="group flex items-center gap-4 px-4 py-3 rounded-2xl text-sm font-medium transition-all duration-300
                        {{ $profilGymActive ? 'bg-gradient-to-r from-gold-500/20 to-transparent text-gold-300 shadow-lg shadow-gold-500/20' : 'text-brand-silver hover:bg-brand-gunmetal/40 hover:text-white hover:translate-x-1' }}"
            ...
            <div class="space-y-2">
                ...
                <a href="#"
                    class="group flex items-center gap-4 px-4 py-3 rounded-2xl text-sm font-medium transition-all duration-300
                        {{ $laporanActive ? 'bg-gradient-to-r from-gold-500/20 to-transparent text-gold-300 shadow-lg shadow-gold-500/20' : 'text-brand-silver hover:bg-brand-gunmetal/40 hover:text-white hover:translate-x-1' }}"
