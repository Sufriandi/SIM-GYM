            ...
            <div class="relative h-full flex flex-col items-center justify-center px-10 py-8 text-center text-brand-black">
                ...
                <div class="mt-8 grid grid-cols-2 gap-4 text-left text-xs text-brand-gunmetal w-full max-w-md">
                    <div class="flex items-center gap-3">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-success-soft text-success">
                    ...
                    <div class="flex items-center gap-3">
                        <span class="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-gold-500/15 text-gold-700">
