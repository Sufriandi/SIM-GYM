                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div class="lg:col-span-4">
                        <div class="card-premium p-5 sm:p-6 rounded-3xl lg:sticky lg:top-28">
                            ...
                            <button type="button" @click="openGateway()" :disabled="!hasItems"
                ...
                <div class="relative w-full max-w-md sm:max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col"
                    ...
                    <div class="px-5 py-4 border-b border-gray-200 bg-gradient-to-b from-white to-gray-50">
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="flex items-center gap-3 min-w-0">
                                <div
                                    class="w-10 h-10 rounded-xl overflow-hidden bg-black flex items-center justify-center flex-shrink-0">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-[11px] text-gray-500 truncate">
                                        <span
                                            x-text="step === 'menu' ? 'Payment Gateway' : 'Payment Instructions'"></span>
                            ...
                            {{-- Close --}}
                            <button type="button" @click="closeAll()" class="text-gray-400 hover:text-red-500"
                                aria-label="Tutup">
                        ...
                        <div
                            class="mt-4 bg-white border border-gray-200 rounded-xl p-4 flex items-center justify-between">
                            <div>
                                <p class="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Total Tagihan
                                </p>
                                <p class="text-xl sm:text-2xl font-extrabold text-gray-900 leading-tight"
                                    x-text="idr(total)"></p>

                                <p class="text-[11px] text-gray-500" x-show="step === 'inst'">
                                    Metode:
                                    <span class="font-semibold text-gray-800"
                                        x-text="selectedType === 'bank' ? 'Transfer Bank' : 'QRIS'"></span>
                                    <span class="text-gray-400">•</span>
                                    <span class="font-semibold text-gray-800" x-text="selectedTitle"></span>
                                </p>
                            </div>
                            <span
                                class="text-[10px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 px-2 py-1 rounded-lg">
                                Secured
                            </span>
                        </div>

                        <div class="mt-3 flex items-center justify-between bg-blue-50 border border-blue-100 rounded-xl px-4 py-2"
                            x-show="step === 'inst'">
                    ...
                    <div class="p-4 overflow-y-auto custom-scrollbar-light flex-1">
                        <div x-show="step === 'menu'" x-transition.opacity>
                            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 px-1">Metode
                                Pembayaran</p>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl mb-3 overflow-hidden">
                                <button type="button" @click="accordion = (accordion === 'bank' ? null : 'bank')"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        :class="accordion === 'bank' ? 'rotate-180' : ''">
                                        <path d="m6 9 6 6 6-6" />
                                    </svg>
                                </button>

                                <div x-show="accordion === 'bank'" x-transition.opacity
                                    ...
                                    @if (!empty($rekenings) && count($rekenings) > 0)
                                        @foreach ($rekenings as $bank)
                                            <button type="button"
                                                ...
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="h-8 w-12 bg-white border border-gray-200 rounded-lg flex items-center justify-center text-[9px] font-bold text-gray-600 uppercase">
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                                <button type="button" @click="accordion = (accordion === 'qris' ? null : 'qris')"
                                    ...
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-9 h-9 rounded-lg bg-gray-100 text-gray-600 flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="text-gray-400 transition-transform"
                                        :class="accordion === 'qris' ? 'rotate-180' : ''">
                                        <path d="m6 9 6 6 6-6" />
                                    </svg>
                                </button>

                                <div x-show="accordion === 'qris'" x-transition.opacity
                                    class="border-t border-gray-100">
                                    <button type="button"
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="h-8 w-12 bg-white border border-gray-200 rounded-lg flex items-center justify-center text-[9px] font-bold text-gray-600">
                                                QRIS</div>
                                            <div class="text-left">
                            ...
                            <div x-show="selectedType === 'bank'" x-transition.opacity>
                                <div class="bg-white border border-gray-200 rounded-xl p-4 mb-5">
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="font-mono text-lg sm:text-xl font-bold text-blue-700 tracking-wider"
                                            x-text="selectedValue"></span>
                                        <button type="button" @click="copyText(selectedValue)"
                                            class="text-xs font-bold text-gray-500 hover:text-blue-700 uppercase">Salin</button>
                                    </div>
                            ...
                            <div x-show="selectedType === 'qris'" x-transition.opacity class="text-center">
                                <template x-if="selectedValue">
                                    <div class="bg-white border border-gray-200 rounded-xl p-5">
                                        <div
                                            class="mx-auto w-56 h-56 bg-white border border-gray-200 rounded-2xl flex items-center justify-center overflow-hidden">
                                            <img :src="selectedValue" alt="QRIS"
                                                class="w-full h-full object-contain">
                                        </div>
                                        <p class="mt-4 text-sm font-bold text-gray-900" x-text="selectedExtra"></p>
                                        <p class="text-xs text-gray-600">Gunakan QR ini di e-wallet atau mobile banking
                                            Anda.</p>
                                    </div>
                                </template>
                                ...
                                <template x-if="!selectedValue">
                                    <div class="bg-white border border-gray-200 rounded-xl p-5 text-left">
                                        ...
                                        <p class="text-xs text-gray-600">Gambar QRIS belum diatur. Silakan gunakan
                                            Transfer Bank atau set QRIS dulu di admin.</p>
                                    </div>
                                </template>
                            </div>
                        </div>
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2 top-3 z-50" x-show="toast.show"
                        x-transition.opacity>
            ...
            function cartPage() {
                ...
                return {
                    ...
                    get waLink() {
                        ...
                        const msg =
                            `Halo Admin BETA GYM, saya sudah bayar ${typeText} senilai ${this.idr(this.total)} untuk Order {{ $orderId }}.`;
