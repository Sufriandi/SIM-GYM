{{-- resources/views/member/produk_gym/partials/payment_modal.blade.php --}}
@php
            ...
            return {
                ...
                init() {
                    ...
                    window.addEventListener('payment:open', (e) => {
                        const d = e?.detail || {};
                        this.total   = Number(d.total || this.total || 0);
                        this.orderId = String(d.orderId || this.orderId || '');
                        this.waAdmin = String(d.waAdmin || this.waAdmin || '');
                        this.openModal();
                    });

                    // update total while open
                    window.addEventListener('payment:update', (e) => {
                        const d = e?.detail || {};
