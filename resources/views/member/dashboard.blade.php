...
>
    <div class="space-y-8 pb-12">
        ...
        ========================================================== --}}
        <section
            class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1a1a1a] via-[#2a2a2a] to-[#111111] p-8 lg:p-10 border border-white/5 shadow-2xl"
        >
            ...
            <div class="absolute top-0 right-0 w-80 h-80 bg-gold-500/10 rounded-full blur-3xl -mr-24 -mt-24 pointer-events-none"></div>
            <div class="absolute bottom-0 left-0 w-64 h-64 bg-gold-700/10 rounded-full blur-3xl -ml-20 -mb-24 pointer-events-none"></div>
            ...
            <div class="relative flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div class="flex-1">
                    <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold-500/20 border border-gold-500/30 backdrop-blur-sm mb-4">
                        ...
                        <p class="text-gold-300 font-bold uppercase tracking-[0.25em] text-[10px]">
                            Member Dashboard
                        </p>
                        @if($membershipAktif)
                            <span class="text-[10px] font-semibold text-emerald-300 flex items-center gap-1">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-400"></span>
                                Membership Aktif
                            </span>
                        @else
                            <span class="text-[10px] font-semibold text-red-300 flex items-center gap-1">
                    ...
                    <h1 class="text-4xl lg:text-5xl font-heading font-black text-white tracking-tight leading-tight">
                        {{ $greeting }},
                        <span class="block mt-2 bg-gradient-to-r from-gold-300 via-gold-500 to-gold-600 bg-clip-text text-transparent">
                            {{ $firstName }}!
                        </span>
                    </h1>

                    <p class="text-sm lg:text-base text-white/70 mt-3 max-w-xl">
                        Pantau status membership, kehadiran latihan, dan riwayat izin Anda dalam satu tampilan.
                    </p>

                    @if (! $membershipAktif)
                        <div class="mt-4 inline-flex items-start gap-3 px-4 py-3 rounded-2xl bg-red-500/10 border border-red-400/40 text-xs text-red-100 max-w-xl">
                            <i data-lucide="alert-triangle" class="w-4 h-4 mt-0.5"></i>
                            <div>
                                <p class="font-semibold">Membership Anda sudah tidak aktif.</p>
                                <p class="mt-0.5">
                ...
                <div class="hidden lg:flex items-center gap-4 bg-white/5 border border-white/10 px-6 py-3 rounded-2xl backdrop-blur-sm">
                    <div class="p-3 bg-gold-500/20 rounded-xl text-gold-300">
        ...
        ========================================================== --}}
        <section
            class="rounded-3xl bg-[#151515] border border-white/10 shadow-2xl overflow-hidden relative group"
        >
            <div class="absolute inset-0 bg-gradient-to-r from-gold-500/8 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div class="lg:col-span-2 p-6 lg:p-8 bg-[#1a1a1a] border-b lg:border-b-0 lg:border-r border-white/5 flex items-center justify-center relative overflow-hidden">
                    ...
                    <div class="relative w-full aspect-[1.586/1] max-w-[400px] perspective-1000 group/card">
                        <div
                            class="relative h-full w-full rounded-2xl bg-[#050505] border border-white/10 shadow-2xl overflow-hidden transform transition-transform duration-500 group-hover/card:scale-105 group-hover/card:rotate-1"
                        >
                            ...
                            <div class="relative z-10 h-full p-6 flex flex-col justify-between text-white">
                                <div class="flex justify-between items-start">
                                    <span class="font-heading font-black italic text-xl tracking-[0.22em] text-gold-400">
                                        BETA&nbsp;GYM
                                    </span>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="font-mono text-lg md:text-xl font-bold tracking-[0.25em] text-white/90 drop-shadow-md">
                                        {{ $formattedId }}
                                    </p>
                                </div>
                                ...
                                <div class="flex justify-between items-end text-[10px] uppercase tracking-wider font-bold text-white/50">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-gold-400 text-xs">
                ...
                <div class="lg:col-span-3 p-6 lg:p-10 flex flex-col justify-center relative">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                        <div>
                            <p class="text-[10px] font-bold text-white/40 uppercase tracking-[0.28em] mb-1">
                                Status Keanggotaan
                            </p>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-8">
                        <div>
                            <p class="text-[10px] font-bold text-white/40 uppercase tracking-[0.22em] mb-2">
                                Sisa Masa Aktif
                            </p>
                            <div class="flex items-baseline gap-2">
                                <span class="text-5xl font-heading font-black {{ $membershipAktif ? 'text-white' : 'text-red-400' }}">
                                    {{ $sisaHari }}
                                </span>
                            ...
                            <p class="text-[11px] text-white/50 mt-1">
                                Dari total
                                <span class="font-semibold">{{ $totalDurasi ?: '–' }}</span>
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-gold-300 font-mono">
                                {{ $tglAkhirFormatted }}
                            </p>
                            @if ($mulai)
                                <p class="text-[11px] text-white/50 mt-1">
                    ...
                    <div class="space-y-6">
                        {{-- PROGRESS --}}
                        <div class="space-y-2">
                            <div class="flex justify-between text-[11px] font-bold text-white/40">
                            ...
                            <div class="w-full h-3 bg-white/5 rounded-full overflow-hidden">
                                <div
                                    class="h-full rounded-full transition-all duration-1000
                                        {{ $membershipAktif ? 'bg-gradient-to-r from-gold-600 via-gold-400 to-emerald-400' : 'bg-red-500/60' }}"
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-2">
                            @if (! $membershipAktif)
                                <a
                                    href="#"
                                    class="flex-1 py-3.5 px-6 bg-red-600 hover:bg-red-500 text-white rounded-xl font-bold uppercase tracking-wide text-sm flex items-center justify-center gap-2 shadow-lg shadow-red-900/25 transition-all hover:scale-[1.02]"
                                >
                            ...
                            @else
                                <button
                                    type="button"
                                    class="flex-1 py-3.5 px-6 bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 transition-colors"
                                >
                                    <i data-lucide="file-text" class="w-4 h-4 text-gold-400"></i>
                            ...
                            <a
                                ...
                                class="flex-1 py-3.5 px-6 bg-gold-500 hover:bg-gold-400 text-black rounded-xl font-semibold text-sm flex items-center justify-center gap-2 transition-transform active:scale-[0.98]"
                            >
        ...
        <section class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {{-- QUICK ACTION IZIN --}}
            <div class="lg:col-span-2 relative overflow-hidden rounded-3xl bg-[#1b1b1b] border border-white/10 p-1 group">
                ...
                <div class="relative h-full bg-[#151515] rounded-[22px] p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div class="flex items-center gap-5">
                        <div class="w-14 h-14 rounded-2xl bg-gold-500/10 border border-gold-500/30 flex items-center justify-center text-gold-300">
                    ...
                    @if ($membershipAktif)
                        <a href="{{ route('member.izin_latihan.create') }}" class="w-full md:w-auto">
                            <button
                                class="w-full md:w-auto px-6 py-3 rounded-xl bg-gold-500 hover:bg-gold-400 text-black font-semibold text-sm flex items-center justify-center gap-2 transition-transform active:scale-[0.97]"
                            >
                    ...
                    @else
                        <button
                            type="button"
                            class="w-full md:w-auto px-6 py-3 rounded-xl bg-white/10 text-white/40 font-semibold text-sm flex items-center justify-center gap-2 cursor-not-allowed border border-white/10"
            ...
            {{-- IZIN STATS --}}
            <div class="rounded-3xl bg-[#1b1b1b] border border-white/10 p-6 flex flex-col justify-between hover:border-gold-500/30 transition-colors">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-[10px] font-bold text-white/40 uppercase tracking-[0.26em]">
                            Status Pengajuan Izin
                        </p>
                        <h3 class="text-4xl font-heading font-black text-white mt-2">
                            {{ $izinStats['pending'] ?? 0 }}
                        </h3>
                    ...
                    <div class="p-2 rounded-lg bg-white/5">
                        <i data-lucide="file-clock" class="w-5 h-5 text-gold-400"></i>
                    </div>
                </div>

                <div class="mt-4 grid grid-cols-3 gap-2 text-[11px] text-white/60">
                    <div class="flex flex-col">
                        <span class="font-semibold text-white/70">{{ $izinStats['disetujui'] ?? 0 }}</span>
                        <span class="uppercase tracking-[0.22em] text-[10px]">Disetujui</span>
                    </div>
                    <div class="flex flex-col">
                        <span class="font-semibold text-white/70">{{ $izinStats['ditolak'] ?? 0 }}</span>
                        <span class="uppercase tracking-[0.22em] text-[10px]">Ditolak</span>
                    </div>
                    <div class="flex flex-col">
                        <span class="font-semibold text-white/70">{{ $izinStats['total'] ?? 0 }}</span>
                ...
                <div class="mt-4 pt-4 border-t border-white/5 flex justify-between items-center">
                    ...
                    <a
                        ...
                        class="text-[11px] font-semibold text-gold-400 hover:text-gold-300 flex items-center gap-1"
                    >
                        Lihat Pending
        ...
        <section class="grid grid-cols-1 md:grid-cols-4 gap-4 lg:gap-6">
            {{-- Hadir Bulan Ini --}}
            <div class="rounded-2xl bg-[#181818] border border-white/10 p-4 flex flex-col gap-2">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-[10px] font-bold text-white/40 uppercase tracking-[0.26em]">
                            Hadir Bulan Ini
                        </p>
                        <p class="text-3xl font-heading font-black text-white mt-1">
                            {{ $hadirBulanIni }}
                        </p>
                    </div>
                    <div class="p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
                        <i data-lucide="check-square-2" class="w-4 h-4 text-emerald-300"></i>
                    </div>
                </div>
            ...
            <div class="rounded-2xl bg-[#181818] border border-white/10 p-4 flex flex-col gap-2">
                <div class="flex justify-between items-start">
                    ...
                    <div class="p-2 rounded-lg bg-sky-500/10 border border-sky-500/30">
                        <i data-lucide="calendar-check-2" class="w-4 h-4 text-sky-300"></i>
                    </div>
                </div>
                <p class="text-[11px] text-white/55 mt-1">
            ...
            <div class="rounded-2xl bg-[#181818] border border-white/10 p-4 flex flex-col gap-2">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-heading font-black text-emerald-300 mt-1">
            ...
            <div class="rounded-2xl bg-[#181818] border border-white/10 p-4 flex flex-col gap-2">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-heading font-black text-red-300 mt-1">
                            {{ $izinStats['ditolak'] ?? 0 }}
                        </p>
                    </div>
                    <div class="p-2 rounded-lg bg-red-500/10 border border-red-500/30">
                        <i data-lucide="circle-x" class="w-4 h-4 text-red-300"></i>
                    </div>
                </div>
                <p class="text-[11px] text-white/55 mt-1">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {{-- AKTIVITAS HARI INI --}}
            <div class="lg:col-span-1 rounded-3xl bg-[#181818] border border-white/10 p-6 flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="p-2 rounded-xl bg-white/5">
                        <i data-lucide="sun-medium" class="w-4 h-4 text-gold-300"></i>
                    </div>
                </div>
                ...
                <div class="mt-2 space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center">
                            <i data-lucide="shield-check" class="w-4 h-4 text-gold-300"></i>
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center">
                            <i data-lucide="{{ $todayAttendance ? 'check-circle-2' : 'circle-dashed' }}" class="w-4 h-4 {{ $todayAttendance ? 'text-emerald-300' : 'text-white/40' }}"></i>
                        </div>
                        <div class="flex-1">
                            <p class="text-xs font-semibold text-white/70">
                                Absensi Hari Ini
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center">
                            <i data-lucide="file-clock" class="w-4 h-4 text-yellow-300"></i>
                        </div>
                        <div class="flex-1">
                            <p class="text-xs font-semibold text-white/70">
                                Izin Pending
                ...
                <div class="mt-4 pt-4 border-t border-white/10">
                    <a
                        href="{{ route('member.kehadiran.index') }}"
                        class="text-[11px] font-semibold text-gold-300 hover:text-gold-200 flex items-center gap-1"
                    >
            ...
            <div class="lg:col-span-2 rounded-3xl bg-[#181818] border border-white/10 p-6 overflow-hidden">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="hidden sm:flex text-[11px] text-white/40 gap-2">
                ...
                <div class="w-full overflow-x-auto custom-scrollbar">
                    <table class="min-w-full text-xs">
                        <thead>
                            <tr class="border-b border-white/10 text-[10px] uppercase tracking-[0.18em] text-white/40">
                        ...
                        <tbody class="divide-y divide-white/5">
                            @forelse($recentAttendance as $row)
                                <tr class="hover:bg-white/5 transition-colors">
                                    <td class="py-2 pr-4 align-middle text-white/80">
                                        {{ $row->tanggal?->format('d M Y') }}
                                    </td>
                                    <td class="py-2 px-4 align-middle text-white/70">
                                        {{ $row->jam_masuk ? Carbon::parse($row->jam_masuk)->format('H:i') : '-' }}
                                    </td>
                                    <td class="py-2 px-4 align-middle text-white/60 text-[11px]">
                                    ...
                                    <td class="py-2 px-4 align-middle">
                                        ...
                                        <span
                                            class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold
                                                {{ $isValid ? 'bg-emerald-500/10 text-emerald-300 border border-emerald-500/30' : 'bg-yellow-500/10 text-yellow-300 border border-yellow-500/30' }}"
                                        >
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="py-4 text-center text-[11px] text-white/50">
        ...
        ========================================================== --}}
        <section class="rounded-3xl bg-[#181818] border border-white/10 p-6 space-y-4">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-base font-bold text-white">
                ...
                @forelse($recentIzin as $izin)
                    @php
                        ...
                        $statusMeta = match ($status) {
                            'pending'   => ['label' => 'Pending',   'class' => 'bg-yellow-500/10 text-yellow-300 border-yellow-500/30'],
                            'disetujui' => ['label' => 'Disetujui', 'class' => 'bg-emerald-500/10 text-emerald-300 border-emerald-500/30'],
                            'ditolak'   => ['label' => 'Ditolak',   'class' => 'bg-red-500/10 text-red-300 border-red-500/30'],
                            default     => ['label' => ucfirst($status), 'class' => 'bg-white/5 text-white/60 border-white/20'],
                        };
                    @endphp
                    <div class="rounded-2xl bg-[#151515] border border-white/10 px-4 py-3 flex items-start gap-3">
                        <div class="mt-1">
                            <div class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center">
                                <i data-lucide="sticky-note" class="w-4 h-4 text-gold-300"></i>
                            </div>
                        </div>
                        <div class="flex-1 space-y-1">
                            ...
                            <p class="text-[11px] text-white/60 line-clamp-2">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {{-- PRODUK GYM --}}
            <div class="lg:col-span-2 rounded-3xl bg-[#181818] border border-white/10 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @forelse($produkTerbaru as $produk)
                        <div class="rounded-2xl bg-[#151515] border border-white/10 overflow-hidden flex">
                            <div class="w-24 h-24 bg-black/40 flex-shrink-0">
                                @if($produk->foto)
                                    <img
                                    ...
                                    >
                                @else
                                    <div class="w-full h-full flex items-center justify-center text-[10px] text-white/40">
                                        No Image
                                    </div>
                                @endif
                            </div>
                            <div class="flex-1 px-4 py-3 flex flex-col justify-between">
                                <div>
                                    <p class="text-xs font-semibold text-white line-clamp-1">
                                        {{ $produk->nama }}
                                    </p>
                                ...
                                <div class="flex items-center justify-between mt-1">
                                    <p class="text-sm font-bold text-gold-300">
            ...
            {{-- COACH --}}
            <div class="rounded-3xl bg-[#181818] border border-white/10 p-6 space-y-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-base font-bold text-white">
                            Tim Coach BETA GYM
                    ...
                    <div class="p-2 rounded-xl bg-white/5">
                        <i data-lucide="users" class="w-4 h-4 text-gold-300"></i>
                    </div>
                </div>

                <div class="space-y-3">
                    @forelse($coaches as $coach)
                        <div class="rounded-2xl bg-[#151515] border border-white/10 px-4 py-3 flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-white/5 overflow-hidden flex-shrink-0">
                                @if($coach->foto)
                                    <img
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-[11px] text-white/45 line-clamp-2">
