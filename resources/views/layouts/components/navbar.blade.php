...
<nav class="fixed top-0 left-0 right-0 h-16 bg-dark-card border-b-2 border-gold-900 z-50 flex items-center justify-between pr-4 lg:pr-6 transition-all duration-300"
    ...
    <div class="flex items-center space-x-4">
        ...
        {{-- Notifikasi Button --}}
        <div class="relative">
            <button class="relative flex items-center justify-center w-10 h-10 rounded-gym bg-dark-surface border border-gold-900 text-text-secondary hover:text-gold hover:border-gold transition duration-200 focus:outline-none group">
