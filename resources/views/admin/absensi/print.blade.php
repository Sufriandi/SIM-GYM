...
@php
    ...
    $qrSnippet = isset($periodeAktif->kode_qr) ? strtoupper(substr($periodeAktif->kode_qr, 0, 8)) : 'UNKNOWN';
@endphp
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-200 w-full max-w-sm overflow-hidden">
            ...
            <div class="px-6 pt-6 pb-6 flex flex-col items-center gap-4">
                ...
                <div class="w-full flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="w-9 h-9 rounded-full overflow-hidden bg-gray-900 flex items-center justify-center">
                            <img src="{{ asset('images/logo.webp') }}" alt="Logo {{ $gymName }}"
                ...
                <div class="mt-3 flex items-center justify-center gap-2 text-[10px] text-gray-600">
                    <span
                        class="inline-flex items-center px-3 py-1 rounded-full bg-gray-100 text-gray-700 border border-gray-200">
                        Scan QR
                    </span>
                    ...
                    <span class="text-gray-400">➝</span>
                    <span
                        class="inline-flex items-center px-3 py-1 rounded-full bg-gray-900 text-amber-400 border border-gray-900">
                        Selesai
                    </span>
                </div>
                ...
                {{-- Footer --}}
                <div
                    class="mt-4 pt-3 border-t border-gray-200 w-full text-[9px] text-gray-400 flex items-center justify-between">
