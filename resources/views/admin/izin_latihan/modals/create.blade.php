                        ...
                        <div class="md:col-span-1">
                            <div class="rounded-2xl border border-brand-borderSoft/70 bg-brand-card p-4 flex flex-col items-center gap-3">
                                ...
                                <p class="text-[11px] text-text-muted text-center">
                                    Lokasi simpan: <span class="font-mono text-[10px]">public/images/uploads/bukti_izin</span>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="rounded-2xl border border-brand-borderSoft/70 bg-brand-card p-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        {{-- LIST MEMBER --}}
                                        <div
                                            class="max-h-40 rounded-xl border border-brand-borderSoft/70 bg-brand-shell overflow-y-auto custom-scrollbar"
                                            ...
                                            <template x-for="m in filteredMembers" :key="m.id">
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        ...
                                                        :class="selectedId === m.id ? 'border-primary text-primary-dark bg-primary-soft/40' : 'border-transparent text-text-muted'"
                                                    >
