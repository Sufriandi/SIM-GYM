{{-- resources/views/laporan/keuangan/produk.blade.php --}}

<x-layouts.admin title="Laporan Keuangan - Produk">
    <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <input type="text" name="q" value="{{ $q }}"
                        placeholder="No nota / nama buyer / keterangan"
                        class="mt-1 w-full rounded-xl border-gray-200 focus:border-gray-400 focus:ring-0">
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div class="rounded-3xl border bg-white p-6 shadow-sm lg:col-span-1" x-data="kpiCard({ value: {{ (int) $total }} })">
                <p class="text-sm font-medium text-gray-500">Total Pendapatan Produk</p>
            ...
            <div class="rounded-3xl border bg-white p-6 shadow-sm lg:col-span-2">
                ...
                <div class="mt-4">
                    <canvas id="chartProdukMetode" height="120"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-3xl border bg-white shadow-sm overflow-hidden">
            <div class="p-5 border-b">
                <h2 class="text-base font-semibold">Detail Transaksi Produk</h2>
                <p class="text-sm text-gray-500">Menampilkan transaksi produk yang valid (tidak dibatalkan).</p>
            </div>
