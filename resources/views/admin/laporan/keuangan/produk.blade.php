    ...
    <div class="space-y-6 font-sans text-text-main">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2 justify-start lg:justify-end">
                <form method="GET" action="{{ route('admin.laporan.keuangan.produk') }}" class="flex flex-wrap items-center gap-2">
                    {{-- Date Range --}}
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="q" value="{{ $q }}" placeholder="Cari nota / pembeli..."
                    ...
                    <div x-show="open" x-cloak @click.away="open=false"
                        ...
                        <a class="flex items-center gap-2.5 px-4 py-2.5 text-xs hover:bg-brand-shell/40 transition"
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="text-[11px] text-text-muted">Rekap laporan produk.</div>
                            </div>
                        </a>
                        ...
                        <a class="flex items-center gap-2.5 px-4 py-2.5 text-xs hover:bg-brand-shell/40 transition"
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="text-[11px] text-text-muted">Siap cetak, khusus laporan produk.</div>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {{-- Omzet Produk (Hero Dark Card - Emerald Theme) --}}
            <div class="relative overflow-hidden rounded-2xl bg-[#064e3b] p-5 shadow-xs border border-emerald-900/60 flex flex-col justify-between min-h-[135px]">
                <div class="relative z-10">
                    <div class="flex items-center justify-between">
                        <p class="text-[11px] font-bold uppercase tracking-wider text-emerald-200/80">Omzet Produk Retail</p>
                ...
                <div class="relative z-10 mt-3">
                    ...
                    <p class="mt-1.5 text-[10px] text-emerald-200/70 truncate">Total pendapatan dari penjualan barang</p>
                </div>
            ...
            <div class="bg-white dark:bg-brand-card border border-brand-borderSoft rounded-2xl p-5 shadow-xs flex flex-col justify-between min-h-[135px] hover:border-emerald-300 transition-colors">
                ...
                <p class="mt-3 text-[10px] text-text-muted">Jumlah struk penjualan yang diterbitkan.</p>
            </div>
            ...
            <div class="bg-white dark:bg-brand-card border border-brand-borderSoft rounded-2xl p-5 shadow-xs flex flex-col justify-between min-h-[135px] hover:border-emerald-300 transition-colors">
                ...
                <p class="mt-3 text-[10px] text-text-muted">Nilai rata-rata per transaksi pembelanjaan.</p>
            </div>
        </div>
