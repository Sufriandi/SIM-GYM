...
<body>
    ...
    <div class="row">
        <div class="box">
            <div class="muted">Total Omzet Produk</div>
    ...
    <h2 style="font-size:13px; margin-top:16px;">Produk Terlaris (Top 10 Qty)</h2>
    <table>
        <thead><tr><th>Produk</th><th class="text-right">Qty Terjual</th></tr></thead>
        <tbody>
