                ...
                <table class="table-fixed w-full border-collapse text-sm md:min-w-[900px]">
                    <thead>
                        <tr class="border-b border-brand-borderSoft bg-brand-surface-50">
                            ...
                            <th class="p-3 text-left text-[11px] font-semibold uppercase tracking-wide text-text-muted w-[10%]">
                                Foto
                            </th>
                            <th class="p-3 text-left text-[11px] font-semibold uppercase tracking-wide text-text-muted w-[24%]">
                                Nama
                            </th>
                            <th class="p-3 text-center text-[11px] font-semibold uppercase tracking-wide text-text-muted w-[15%]">
                                Kondisi
                            </th>
