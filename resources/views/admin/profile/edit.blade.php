                ...
                <div class="relative p-6 bg-brand-card">
                    ...
                    <div class="relative">
                        ...
                        <div class="flex flex-col items-center text-center">
                            ...
                            <div class="mt-3 flex flex-wrap justify-center gap-2">
                                ...
                                @if(!empty($user?->username))
                                    <span class="inline-flex items-center rounded-full bg-brand-surface-100 px-3 py-1 text-xs text-text-muted">
                        ...
                        <div class="mt-6 pt-4 border-t border-brand-borderSoft flex justify-end">
                            <button type="button" @click="pickTab('security')" class="text-xs font-semibold text-primary-dark hover:underline">
                                Ganti Password?
                            </button>
                        </div>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div x-show="tab==='profile'" x-cloak class="relative p-6">
                        ...
                        <form method="POST" action="{{ route($routeUpdate) }}" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <input x-ref="fileInput" type="file" name="foto" accept="image/*" class="hidden" @change="onPickPhoto($event)">
                    ...
                    <div x-show="tab==='security'" x-cloak class="relative p-6">
                        <div class="mb-5 border-l-4 border-gold-600 pl-3">
                            ...
                            <p class="text-xs text-text-muted mt-0.5">Disarankan kombinasi huruf & angka minimal 8 karakter.</p>
                        </div>
