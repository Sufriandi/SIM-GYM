        ...
        <div class="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6 animate-slide-up" style="animation-delay: 0.2s;">
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                    {{-- Button Primary --}}
                    <button class="px-8 py-4 rounded-pill font-heading font-bold text-brand-nav tracking-wide bg-gold-500 hover:bg-gold-400 shadow-gold-glow hover:-translate-y-1 transition-all duration-normal active:scale-98">
                        Mulai Free Trial
                    </button>
                    {{-- Button Secondary --}}
                    <button class="px-8 py-4 rounded-pill font-heading font-bold text-brand-white border border-brand-borderSoft/20 hover:bg-brand-white/10 transition-all duration-normal flex items-center justify-center gap-2 group">
        ...
        <div class="relative w-full">
            <div class="flex w-[200%] animate-marquee items-center gap-16 whitespace-nowrap">
                ...
                <div class="flex items-center gap-2 opacity-30 hover:opacity-100 transition-opacity cursor-default group">
                    ...
                    <span class="font-display font-bold text-xl text-brand-silver group-hover:text-brand-white">PARTNER BRAND {{ $i }}</span>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="py-24 bg-brand-nav" id="fasilitas">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-16">
                ...
                <h2 class="mt-2 text-hero font-display text-brand-white">DEFINISIKAN ULANG <br> <span class="text-transparent bg-clip-text bg-brand-gold">POTENSI DIRIMU</span></h2>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="group p-8 rounded-3xl bg-brand-sidebar border border-brand-borderSoft/5 hover:border-gold-500/30 hover:bg-brand-surface-200/5 transition-all duration-normal hover:-translate-y-2 shadow-card">
                    <div class="w-14 h-14 rounded-2xl bg-brand-surface-200/5 border border-brand-borderSoft/10 flex items-center justify-center mb-6 group-hover:bg-gold-500 transition-colors duration-normal">
                        <i data-lucide="biceps-flex" class="w-7 h-7 text-gold-500 group-hover:text-brand-nav transition-colors"></i>
                    </div>
                    ...
                    <p class="text-brand-silver text-sm leading-relaxed">
                        Kami menggunakan peralatan impor standar internasional (Technogym & Rogue) untuk keamanan maksimal.
                    </p>
                </div>
    ...
    <section class="py-24 relative bg-brand-dark" id="program">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                ...
                <a href="#" class="inline-flex items-center gap-2 text-gold-500 font-bold hover:text-gold-400 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 h-[500px]">
                ...
                <div class="md:col-span-2 md:row-span-2 relative group overflow-hidden rounded-3xl cursor-pointer shadow-card">
                    ...
                    <div class="absolute bottom-6 left-6">
                        ...
                        <p class="text-brand-silver text-sm mt-1 h-0 overflow-hidden group-hover:h-auto transition-all duration-300">Bakar kalori maksimal dalam waktu singkat.</p>
                    </div>
                </div>
    ...
    <section class="py-24 bg-brand-footer relative overflow-hidden" id="membership">
        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="grid md:grid-cols-3 gap-8 items-start">
                ...
                {{-- Plan 1 --}}
                <div class="bg-brand-sidebar p-8 rounded-3xl border border-brand-borderSoft/10 hover:border-brand-borderSoft/30 transition-all duration-normal shadow-card">
                    ...
                    <ul class="space-y-4 mb-8 text-brand-silver text-sm">
                        <li class="flex items-center gap-3"><i data-lucide="check" class="w-5 h-5 text-success"></i> Akses Gym 09.00 - 15.00</li>
                        <li class="flex items-center gap-3"><i data-lucide="check" class="w-5 h-5 text-success"></i> Loker Standar</li>
                        <li class="flex items-center gap-3"><i data-lucide="check" class="w-5 h-5 text-success"></i> 1x Sesi Coach Intro</li>
                    </ul>
                    <a href="#" class="block w-full py-3 rounded-pill border border-brand-borderSoft/20 text-center text-brand-white font-bold hover:bg-brand-white hover:text-brand-nav transition-all">Pilih Paket</a>
                </div>

                {{-- Plan 2 (Featured) --}}
                <div class="relative p-8 rounded-3xl bg-brand-surface-200/5 border-2 border-gold-600 shadow-gold-glow transform md:-translate-y-4">
                    ...
                    <div class="my-6">
                        <span class="text-5xl font-display font-bold text-transparent bg-clip-text bg-brand-gold">Rp 399k</span>
                        <span class="text-brand-muted text-sm">/bulan</span>
                    </div>
                    <ul class="space-y-4 mb-8 text-brand-white text-sm">
                        <li class="flex items-center gap-3"><i data-lucide="check-circle-2" class="w-5 h-5 text-gold-500"></i> <strong>Akses Unlimited 24/7</strong></li>
                        <li class="flex items-center gap-3"><i data-lucide="check-circle-2" class="w-5 h-5 text-gold-500"></i> Semua Kelas Grup Gratis</li>
                        <li class="flex items-center gap-3"><i data-lucide="check-circle-2" class="w-5 h-5 text-gold-500"></i> Loker VIP + Handuk</li>
                    </ul>
                    <a href="{{ route('register') }}" class="block w-full py-4 rounded-pill bg-accent-gradient text-center text-brand-white font-bold shadow-btn-primary hover:shadow-btn-primary-hover hover:scale-102 transition-all duration-normal">
                        Gabung Sekarang
                    </a>
                </div>
                ...
                <div class="bg-brand-sidebar p-8 rounded-3xl border border-brand-borderSoft/10 hover:border-brand-borderSoft/30 transition-all duration-normal shadow-card">
                    ...
                    <ul class="space-y-4 mb-8 text-brand-silver text-sm">
                        <li class="flex items-center gap-3"><i data-lucide="check" class="w-5 h-5 text-success"></i> Semua Fitur Elite</li>
                        <li class="flex items-center gap-3"><i data-lucide="check" class="w-5 h-5 text-success"></i> 2x Sesi Personal Trainer</li>
                    </ul>
                    <a href="#" class="block w-full py-3 rounded-pill border border-brand-borderSoft/20 text-center text-brand-white font-bold hover:bg-brand-white hover:text-brand-nav transition-all">Pilih Paket</a>
                </div>
            </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="relative rounded-[2.5rem] overflow-hidden bg-brand-ember shadow-card-strong">
                ...
                <div class="relative z-10 px-8 py-20 text-center">
                    ...
                    <p class="text-brand-white/90 text-lg mb-8 max-w-xl mx-auto">Jangan menunggu "waktu yang tepat". Mulailah hari ini dan rasakan bedanya dalam 30 hari pertama.</p>
                    
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="{{ route('register') }}" class="px-10 py-4 bg-brand-white text-brand-nav font-heading font-bold rounded-pill hover:bg-brand-surface-50 transition shadow-xl hover:-translate-y-1">
                            Daftar Member
                        </a>
                        <a href="#" class="px-10 py-4 bg-transparent border-2 border-brand-white text-brand-white font-heading font-bold rounded-pill hover:bg-brand-white hover:text-brand-nav transition">
                            Hubungi WhatsApp
                        </a>
                    </div>
                </div>
