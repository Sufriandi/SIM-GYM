...
@php
    ...
    $waAdmin = $waDigits ?: '6281234567890';
@endphp
    ...
    <section class="relative z-10 pb-16"
        ...
        <div class="container mx-auto px-4 sm:px-6 max-w-6xl">
            ...
            <div class="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
                <a href="{{ route('guest.marketplace.index') }}"
            ...
            {{-- STATE: KOSONG (tanpa reload, muncul jika item habis) --}}
        ...
        {{-- ========================= --}}
        {{-- PAYMENT GATEWAY MODAL (teleport) --}}
        {{-- ========================= --}}
            ...
            function cartPage() {
                return {
                    ...
                    async changeQty(id, op) {
                        ...
                        try {
                            const data = await this.postJson(`/cart/${id}/quantity`, { op });
                            ...
                            if (data.removed) {
                                ...
                                this.items[id].quantity = Number(data.quantity || this.items[id].quantity || 1);
                            }
                    ...
                    async setQty(id, qty) {
                        ...
                        try {
                            const data = await this.postJson(`/cart/${id}/quantity`, { qty: val });
                            ...
                            if (data.removed) {
                                ...
                                this.items[id].quantity = Number(data.quantity || val);
                            }
                    ...
                    async removeItem(id) {
                        ...
                        this.loading[id] = true;
                        try {
                            const data = await this.postJson(`/cart/remove/${id}`, {});
