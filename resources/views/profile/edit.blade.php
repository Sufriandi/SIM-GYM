...
@php
    ...
    // Layout adaptif berdasarkan role (admin pakai layout admin, member pakai layout member)
    $isAdmin = ($user?->role ?? auth()->user()?->role) === 'admin';
    $layoutComponent = $isAdmin ? 'layouts.admin' : 'layouts.member';
@endphp
...
>
    ...
    >
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <x-ui.card class="lg:col-span-4 h-fit {{ $cardLightOverride }}">
                {{-- “header” ala kamu: gradient hanya untuk light --}}
                <div class="p-6 bg-gradient-to-br from-white to-brand-shell/50 dark:bg-transparent">
                    ...
                    <div class="space-y-3">
                        {{-- No. HP --}}
                        <div class="rounded-xl border border-gray-200/80 dark:border-brand-borderSoft/40 bg-white/80 dark:bg-brand-surface-50/50 p-3.5 shadow-sm dark:shadow-none">
                            <div class="flex items-center gap-3">
                                <span class="inline-flex w-9 h-9 items-center justify-center rounded-xl bg-primary-dark/10 dark:bg-primary-dark/20 text-primary-dark shrink-0">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="text-[11px] font-semibold text-gray-500 dark:text-text-muted uppercase tracking-wider">No. Handphone</div>
                                    <div class="text-sm font-bold text-text-main font-mono tracking-tight mt-0.5 truncate">
                                        {{ $user?->no_hp ?: '-' }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="rounded-xl border border-gray-200/80 dark:border-brand-borderSoft/40 bg-white/80 dark:bg-brand-surface-50/50 p-3.5 shadow-sm dark:shadow-none">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="text-[11px] font-semibold text-gray-500 dark:text-text-muted uppercase tracking-wider">Jenis Kelamin</div>
                                    <div class="text-sm font-bold text-text-main mt-0.5 truncate">
                        ...
                        <div class="rounded-xl border border-gray-200/80 dark:border-brand-borderSoft/40 bg-white/80 dark:bg-brand-surface-50/50 p-3.5 shadow-sm dark:shadow-none">
                            <div class="flex items-start gap-3">
                                <span class="inline-flex w-9 h-9 items-center justify-center rounded-xl bg-primary-dark/10 dark:bg-primary-dark/20 text-primary-dark shrink-0 mt-0.5">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="text-[11px] font-semibold text-gray-500 dark:text-text-muted uppercase tracking-wider">Alamat</div>
                                    <div class="text-sm text-text-main font-medium leading-relaxed mt-0.5 break-words line-clamp-3">
                                        {{ $user?->alamat ?: '-' }}
                                    </div>
                                </div>
                            </div>
