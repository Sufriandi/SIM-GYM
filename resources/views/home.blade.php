...
@php
    ...
    // =========================
    $allPaketUrl = Route::has('guest.membership.index')
        ? route('guest.membership.index')
        : (Route::has('guest.paket-membership.index')
            ? route('guest.paket-membership.index')
            : url('/membership'));

    $allCoachUrl = Route::has('guest.coaches.index')
        ? route('guest.coaches.index')
        : (Route::has('guest.coach.index')
    ...
    $highlights = [
        [
            'icon' => 'shield-check',
            'title' => 'Membership Lebih Pasti',
            'desc' => 'Status aktif dan masa berlaku jelas, jadi Anda tahu progresnya dari awal.',
        ],
        [
            'icon' => 'qr-code',
            'title' => 'Absensi Lebih Rapi',
            'desc' => 'Pencatatan kunjungan cepat dan konsisten untuk kebutuhan evaluasi gym.',
        ],
        [
            'icon' => 'wallet',
            'title' => 'Pembayaran Lebih Nyaman',
            'desc' => 'Instruksi pembayaran ringkas, proses konfirmasi lebih terarah.',
        ],
        [
            'icon' => 'shopping-bag',
            'title' => 'Produk Pendukung Latihan',
            'desc' => 'Kebutuhan latihan tersedia dan mudah dicari dalam satu tempat.',
        ],
    ];
@endphp
...
<x-layouts.guest :title="$pageTitle">
    ...
    <style>
        ...
        .soft-scroll::-webkit-scrollbar-thumb {
            background: rgba(212, 167, 87, .22);
            border-radius: 999px;
        }

        .soft-scroll {
            scrollbar-color: rgba(212, 167, 87, .22) rgba(255, 255, 255, .04);
    ...
    <div class="dark bg-brand-bg text-brand-text min-h-screen">
        ...
        <section class="relative overflow-hidden min-svh flex items-center">
            ...
            <div class="absolute inset-0">
                <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop"
                    alt="Gym Background" class="w-full h-full object-cover opacity-25" fetchpriority="high">
                <div class="absolute inset-0 bg-brand-overlay-premium"></div>

                {{-- glows --}}
                <div class="absolute -top-24 -right-24 w-[620px] h-[620px] bg-gold-500/10 rounded-full blur-[170px]">
                </div>
                <div
                    class="absolute -bottom-24 -left-24 w-[620px] h-[620px] bg-accent-500/10 rounded-full blur-[180px]">
                </div>

                {{-- texture --}}
                <div class="absolute inset-0 opacity-[0.06]"
                    style="background-image: radial-gradient(#D4A757 1px, transparent 1px); background-size: 38px 38px;">
                </div>
            </div>
            ...
            <div class="relative w-full container mx-auto px-6 py-16 md:py-20">
                <div class="grid lg:grid-cols-12 gap-10 items-center">
                    ...
                    <div class="lg:col-span-7 space-y-7" data-reveal="left" data-delay="0">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill
                                    bg-black/20 backdrop-blur border border-gold-500/20">
                            <span class="relative flex h-2.5 w-2.5">
                                <span
                                    class="animate-ping absolute inline-flex h-full w-full rounded-full bg-gold-400 opacity-60"></span>
                        ...
                        <div class="space-y-4">
                            ...
                            <p class="text-base md:text-lg text-brand-textSoft max-w-2xl leading-relaxed">
                                Program latihan lebih jelas, pilihan paket mudah dipahami, dan coach siap membantu
                                sesuai kebutuhan.
                            </p>
                        </div>
                        ...
                        <div class="grid sm:grid-cols-3 gap-4 pt-6">
                            <div class="surface-card rounded-2xl p-4 sm:p-5" data-reveal="up" data-delay="120">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs text-brand-textSoft font-bold tracking-wider uppercase">Jam
                                            Operasional</p>
                            ...
                            <div class="surface-card rounded-2xl p-4 sm:p-5" data-reveal="up" data-delay="180">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-xs text-brand-textSoft font-bold tracking-wider uppercase">Lokasi
                                        </p>
                            ...
                            <div class="surface-card rounded-2xl p-4 sm:p-5" data-reveal="up" data-delay="240">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-xs text-brand-textSoft font-bold tracking-wider uppercase">Fokus
                                        </p>
                    ...
                    <div class="lg:col-span-5 hidden lg:block" data-reveal="right" data-delay="120">
                        <div class="relative rounded-3xl overflow-hidden surface-card">
                            ...
                            <div class="relative p-6">
                                <div class="rounded-2xl overflow-hidden" style="border:1px solid rgba(212,167,87,.18);">
                                    <div class="aspect-[4/5] bg-black/20">
                                        <img src="https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=2070&auto=format&fit=crop"
                                            alt="Athlete" class="w-full h-full object-cover">
                                    </div>
                                </div>
                            ...
                            <div
                                class="absolute -top-16 -right-16 w-64 h-64 bg-gold-500/10 rounded-full blur-3xl pointer-events-none">
                            </div>
                            <div
                                class="absolute -bottom-16 -left-16 w-64 h-64 bg-accent-500/10 rounded-full blur-3xl pointer-events-none">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-20 md:py-24 relative overflow-hidden">
            <div class="absolute inset-0 pointer-events-none">
                <div class="absolute inset-0 opacity-[0.05]"
                    style="background-image: radial-gradient(#D4A757 1px, transparent 1px); background-size: 42px 42px;">
                </div>
                <div class="absolute -top-28 left-1/3 w-[520px] h-[520px] bg-gold-500/7 rounded-full blur-[160px]">
                </div>
                <div
                    class="absolute -bottom-24 right-1/4 w-[520px] h-[520px] bg-accent-500/7 rounded-full blur-[170px]">
                </div>
            </div>
            ...
            <div class="container mx-auto px-6 relative">
                <div class="grid lg:grid-cols-12 gap-10 items-start">
                    ...
                    <div class="lg:col-span-5" data-reveal="left" data-delay="0">
                        ...
                        <h2
                            class="mt-4 font-display font-extrabold leading-[0.95]
                        ...
                        <p class="mt-4 text-brand-textSoft leading-relaxed">
                            Lokasi, jam operasional, dan fasilitas ditampilkan jelas agar Anda bisa datang dengan
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <div class="mt-2 grid grid-cols-2 gap-x-3 gap-y-2 text-sm text-brand-textSoft">
                                            <div class="flex items-center gap-2"><span class="text-gold-500">✓</span>
                                                Parkir</div>
                                            <div class="flex items-center gap-2"><span class="text-gold-500">✓</span>
                                                Loker</div>
                                            <div class="flex items-center gap-2"><span class="text-gold-500">✓</span>
                    ...
                    <div class="lg:col-span-7" data-reveal="right" data-delay="120">
                        <div class="grid sm:grid-cols-2 gap-5 lg:gap-6">
                            @foreach ($highlights as $idx => $h)
                                <div class="group relative rounded-3xl p-6 sm:p-7 overflow-hidden
                                   ...
                                   transition duration-300"
                                    data-reveal="up" data-delay="{{ 140 + $idx * 70 }}">
                                    {{-- glow halus --}}
                                    <div
                                        class="pointer-events-none absolute -top-24 -right-24 w-64 h-64 bg-gold-500/10 rounded-full blur-[90px]">
                                    </div>
                                    <div
                                        class="pointer-events-none absolute -bottom-28 -left-24 w-72 h-72 bg-accent-500/10 rounded-full blur-[110px]">
                                    </div>
                                    ...
                                    <div
                                        ...
                                        bg-gradient-to-r from-transparent via-gold-500/45 to-transparent opacity-70">
                                    </div>

                                    <div class="relative flex items-start gap-4">
                                        <div
                                            class="shrink-0 w-12 h-12 rounded-2xl bg-black/25
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <div
                                                class="mt-5 inline-flex items-center gap-2 text-[11px]
                                                font-bold tracking-widest uppercase text-gold-500/90">
                                                <span
                                                    class="inline-block h-[2px] w-7 bg-gold-500/60 rounded-full"></span>
                                                <span class="opacity-80 group-hover:opacity-100 transition">Lebih
                                                    nyaman dipakai</span>
        ...
        <section class="py-20 md:py-24 relative overflow-hidden" id="membership">
            <div class="absolute inset-0 pointer-events-none">
                ...
                <div class="absolute -top-24 right-1/3 w-[640px] h-[640px] bg-gold-500/8 rounded-full blur-[170px]">
                </div>
            </div>
            ...
            <div class="container mx-auto px-6 relative">
                <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
                    <div class="max-w-2xl" data-reveal="left" data-delay="0">
                        <span
                            class="text-gold-500 font-bold tracking-widest uppercase text-xs font-heading">Membership</span>
                        <h2
                            class="mt-2 font-display leading-[0.95]
                        ...
                        <p class="text-brand-textSoft mt-4">
                            Mulai dari yang paling ringan sampai yang paling panjang, pilih yang paling nyaman untuk
                            ritme latihan Anda.
                        </p>
                    </div>
                ...
                @if ($paketTop3->count() > 0)
                    ...
                    <div class="lg:hidden -mx-6 px-6" data-reveal="up" data-delay="80">
                        <div data-carousel id="membershipCarousel" data-nudge="1" class="relative">
                            ...
                            <div id="membershipTrack" data-carousel-track
                                ...
                                @foreach ($paketTop3 as $idx => $paket)
                                    @php
                                        ...
                                        $badge = null;
                                        if ($bestValue && $paket->id === $bestValue->id) {
                                            $badge = 'Rekomendasi';
                                        } elseif ($longest && $paket->id === $longest->id) {
                                        ...
                                        <div class="rounded-3xl overflow-hidden surface-card">
                                            <div class="p-6 sm:p-7">
                                                <div class="flex items-start justify-between gap-3">
                                                    <div class="min-w-0">
                                                        <h3 class="text-lg sm:text-xl font-bold font-heading truncate">
                                                            {{ $paket->nama }}</h3>
                                                    ...
                                                    <div class="flex flex-col items-end gap-2">
                                                        @if ($badge)
                                                            <span
                                                                class="px-3 py-1 rounded-pill text-[10px] font-bold tracking-widest uppercase
                                                ...
                                                <p
                                                    class="mt-4 text-sm text-brand-textSoft leading-relaxed line-clamp-3">
                                                ...
                                                <div class="mt-7">
                                                    <a href="{{ $registerUrl }}"
                                                      ...
                                                      transition"
                                                        ...
                                                        Pilih Paket
                                                        <i data-lucide="arrow-right"
                                                            class="w-5 h-5 {{ $isFeatured ? '' : 'text-gold-500' }}"></i>
                                                    </a>
                                                </div>
                                            </div>

                                            <div class="h-1 w-full"
                                                style="background:rgba(212,167,87,{{ $isFeatured ? '.75' : '.35' }});">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                        ...
                                        <div class="mt-7">
                                            <a href="{{ $registerUrl }}"
                                              ...
                                              transition"
                                                ...
                                                Pilih Paket
                                                <i data-lucide="arrow-right"
                                                    class="w-5 h-5 {{ $isCenter ? '' : 'text-gold-500' }}"></i>
                                            </a>
                                        </div>
                                    </div>

                                    <div class="h-1 w-full"
                                        style="background:rgba(212,167,87,{{ $isCenter ? '.75' : '.35' }});"></div>
                                </div>
                            </div>
                        @endforeach
                    </div>
        ...
        @if ($coaches->count() > 0)
            <section class="py-20 md:py-24 relative overflow-hidden" id="coaches">
                <div class="absolute inset-0 pointer-events-none">
                    ...
                    <div
                        class="absolute -top-24 left-1/2 -translate-x-1/2 w-[900px] h-[900px] bg-gold-500/7 rounded-full blur-[170px]">
                    </div>
                </div>
                ...
                <div class="container mx-auto px-6 relative">
                    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
                        <div class="max-w-2xl" data-reveal="left" data-delay="0">
                            <span
                                class="text-gold-500 font-bold tracking-widest uppercase text-xs font-heading">Coach</span>
                            <h2
                                class="mt-2 font-display leading-[0.95]
                                       text-[clamp(34px,4.5vw,60px)]">
                                PILIH COACH<br>
        ...
        @if ($products->count() > 0)
            <section class="py-20 md:py-24 relative overflow-hidden" id="products">
                <div class="absolute inset-0 pointer-events-none">
                    <div class="absolute inset-0 opacity-[0.05]"
                        style="background-image: radial-gradient(#D4A757 1px, transparent 1px); background-size: 44px 44px;">
                    </div>
                    <div
                        class="absolute -bottom-24 left-1/3 w-[820px] h-[820px] bg-accent-500/7 rounded-full blur-[180px]">
                    </div>
                </div>
                ...
                <div class="container mx-auto px-6 relative">
                    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
                        <div class="max-w-2xl" data-reveal="left" data-delay="0">
                            <span
                                class="text-gold-500 font-bold tracking-widest uppercase text-xs font-heading">Produk</span>
                            <h2
                                class="mt-2 font-display leading-[0.95]
                                       text-[clamp(34px,4.5vw,60px)]">
                                PILIH PRODUK<br>
                                ...
                                <article class="snap-start flex-none w-[240px] sm:w-[280px] md:w-[320px]">
                                    <div class="surface-card rounded-3xl overflow-hidden transition">
                                        <a href="{{ $detail }}" class="block">
                                            ...
                                            <div class="p-5">
                                                <h3 class="text-lg font-bold font-heading truncate">
                                                    {{ $name }}</h3>

                                                @if (!is_null($price))
                                                    <p
                                                        class="mt-2 font-display font-extrabold text-2xl text-transparent bg-clip-text bg-brand-gold">
                                                        Rp {{ number_format((float) $price, 0, ',', '.') }}
                                                    </p>
                                                @else
                                                    <p class="mt-2 text-sm text-brand-textSoft">Harga belum tersedia
                                                    </p>
                                                @endif

                                                <div class="mt-5 flex items-center justify-end">
                                                    <span
                                                        class="inline-flex items-center gap-2 text-gold-500 font-bold">
                                                        Lihat Detail
        ...
        <section class="relative overflow-hidden min-svh flex items-center" id="app">
            <div class="absolute inset-0 pointer-events-none">
                <div
                    class="absolute -top-24 left-1/2 -translate-x-1/2 w-[980px] h-[980px] bg-gold-500/7 rounded-full blur-[190px]">
                </div>
                <div class="absolute inset-0 opacity-[0.05]"
                    style="background-image: radial-gradient(#D4A757 1px, transparent 1px); background-size: 46px 46px;">
                </div>
            </div>
            ...
            <div class="container mx-auto px-6 relative py-16 md:py-20">
                <div class="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                    ...
                    <div class="relative flex justify-center" data-reveal="left" data-delay="0">
                        ...
                        <img src="{{ $mockupUrl }}" alt="Aplikasi BETA GYM" width="420" height="840"
                    ...
                    <div class="space-y-8" data-reveal="right" data-delay="120">
                        <div>
                            <h2
                                class="font-display font-extrabold uppercase leading-[0.95]
                        ...
                        <div x-data="{ active: 0 }" class="space-y-4">
                            @php
                                $faq = [
                                    [
                                        't' => 'Info membership mudah dipahami',
                                        'd' =>
                                            'Pilih paket berdasarkan durasi dan kebutuhan, dengan informasi yang jelas sejak awal.',
                                    ],
                                    [
                                        't' => 'Akses coach lebih cepat',
                                        'd' =>
                                            'Lihat profil coach dan konsultasi langsung untuk jadwal dan program latihan.',
                                    ],
                                    [
                                        't' => 'Produk pendukung latihan',
                                        'd' =>
                                            'Cari kebutuhan latihan dengan tampilan yang rapi dan pilihan yang mudah dipahami.',
                                    ],
                                    [
                                        't' => 'Cara daftar membership',
                                        'd' => 'Daftar, pilih paket, lalu aktivasi diproses sesuai ketentuan gym.',
                                    ],
                                    [
                                        't' => 'Metode pembayaran',
                                        'd' =>
                                            'Pembayaran mengikuti metode yang tersedia di gym, dengan instruksi yang ringkas dan jelas.',
                                    ],
                                ];
                            @endphp
                            ...
                            @foreach ($faq as $i => $item)
                                @php $n = $i + 1; @endphp
                                <div class="surface-card rounded-2xl px-5 sm:px-6 py-4" data-reveal="up"
                                    data-delay="{{ 120 + $i * 70 }}">
                                    <button type="button" class="w-full flex items-center justify-between gap-4"
                                        @click="active = (active === {{ $n }} ? 0 : {{ $n }})">
                                        <span
                                            class="text-base sm:text-lg font-bold font-heading uppercase tracking-wide text-brand-text">
                                            {{ $item['t'] }}
                                        </span>
        ...
        <section class="py-20 md:py-24 relative overflow-hidden">
            <div class="absolute inset-0 pointer-events-none">
                <div class="absolute inset-0 bg-brand-radial-gold opacity-12"></div>
                <div
                    class="absolute -top-24 left-1/2 -translate-x-1/2 w-[900px] h-[900px] bg-gold-500/7 rounded-full blur-[190px]">
                </div>
            </div>
                ...
                <div class="surface-card rounded-3xl p-8 md:p-10 overflow-hidden relative">
                    ...
                    <div class="grid lg:grid-cols-12 gap-8 items-center">
                        <div class="lg:col-span-8">
                            <h3
                                class="font-display font-extrabold leading-[0.95]
                                       text-[clamp(28px,3.4vw,44px)]">
                                SIAP MULAI LATIHAN<br>
                                <span class="text-transparent bg-clip-text bg-brand-gold">DENGAN ARAH YANG
                                    JELAS?</span>
                            </h3>
                            <p class="text-brand-textSoft mt-4 max-w-2xl leading-relaxed">
                                Mulai dari paket yang sesuai, lalu tingkatkan konsistensi latihan. Jika perlu, Anda bisa
                                konsultasi dengan coach untuk program yang lebih terarah.
                            </p>
                        </div>
